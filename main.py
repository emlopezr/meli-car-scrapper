...
if len(sys.argv) != 4:
  print("Usage: py main.py car_list.csv details.csv report.csv")
  sys.exit(1)
...
print(f"\n=== Running car_list.py, output: {output1} ===")
subprocess.run([sys.executable, "car_list.py", output1], check=True)
